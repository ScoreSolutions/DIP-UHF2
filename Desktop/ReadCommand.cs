...
namespace Desktop_Reader
{
    public class ReadCommand
    {
        ...
        public DataTable ReadRFID(string strCom, string strBaud)
        {
            try
            {
                Initiate();
                Connect(strCom, strBaud, "open");
                MultiRead("Multiple");
                System.Threading.Thread.Sleep(2000);
                MultiRead("Stop");
                Connect(strCom, strBaud, "close");
                return dtResult;
            }
            catch (Exception e)
            {
        ...
        private void MultiRead(string strMethod)
        {
            ...
            else if (((strMethod.ToLower() == "Stop".ToLower())))
            {
