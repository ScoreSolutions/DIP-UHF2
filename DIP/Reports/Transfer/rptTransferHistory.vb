...
Public Class rptTransferHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DIP.rptTransferHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_filecount() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTransferHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransferHistory = New rptTransferHistory
        rpt.Site = Me.Site
        Return rpt
    End Function
