...
Public Class rptReserveWithLocation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReserveWithLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DIP.rptReserveWithLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReserveWithLocation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReserveWithLocation = New rptReserveWithLocation
        rpt.Site = Me.Site
        Return rpt
    End Function
