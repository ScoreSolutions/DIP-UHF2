            ...
            For i As Integer = 0 To dtInnova.Rows.Count - 1
                ...
                Try
                    ...
                    If dtScore.DefaultView.Count = 0 Then
                        ...
                        sql += "FRM_SUBMIT_DATE, RECEIVE_DATE,PUBLICDATE,APP_SUBMIT_DATE,LEAVEDATE,EJECTDATE,CANCELDATE,CANCELDATE)"
                        ...
                        sql &= "1,'DbAgent',getdate()," & SysSubmitDate & "," & FrmSubmitDate & "," & ReceiveDate & "," & PublicDate & ","
                        sql += AppSubmitDate & "," & LeaveDate & "," & EjectDate & "," & CancelDate & "," & RecoverDate & ")"
